<template>
  <div class="auth-page">
    <div class="app-container relative max-w-120">
      <!-- Auth Background Element (Subtle Decoration) -->
      <div class="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div
          class="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] rounded-full bg-emerald-500/5 blur-[120px]"
        ></div>
        <div
          class="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] rounded-full bg-amber-500/5 blur-[120px]"
        ></div>
      </div>
      ...
      >
        ...
        <div v-if="supportsOtp && !isStaffLogin" class="w-full flex border-b border-gray-200 mb-6">
          <button
            ...
            :class="[
              'flex-1 py-4 font-semibold text-sm transition-all border-b-2 text-center',
              loginMode === 'password'
                ? 'text-[#006c49] border-[#006c49]'
                : 'text-gray-500 hover:text-[#006c49] border-transparent',
            ]"
          >
            Login with Password
          </button>
        ...
        <div
          ...
          class="w-full mb-4 p-3.5 bg-red-50 text-red-600 text-sm rounded-xl border border-red-100 flex items-center gap-2"
        >
        ...
        >
          <div class="space-y-2">
            ...
            <div class="relative flex items-center">
              <span class="material-symbols-outlined absolute left-4 text-gray-400 select-none">{{
                accountIcon
              }}</span>
              <input
                v-model="account"
          ...
          <div class="space-y-2">
            <div class="flex justify-between items-center px-1">
              ...
              <a
                class="text-xs font-semibold text-[#006c49] hover:underline underline-offset-2"
                href="#"
                >Forgot Password?</a
              >
            </div>
            ...
            <div class="flex justify-between items-center px-1">
              ...
              <div class="text-xs font-medium text-gray-400 flex items-center gap-1">
                ...
                <button
                  ...
                  type="button"
                  @click="handleGetOtp"
                  class="text-[#006c49] hover:underline font-semibold"
                >
                  Resend Now
                </button>
              </div>
        ...
        <div class="w-full mt-8 space-y-6">
          ...
          <div class="text-center">
            <p class="text-sm text-gray-500">
              ...
              <a
                v-if="!isStaffLogin"
                class="text-sm font-semibold text-[#006c49] hover:underline underline-offset-4 ml-1"
                href="#"
                >Register</a
              >
      ...
      <div
        class="mt-6 flex justify-center gap-6 opacity-20 grayscale pointer-events-none select-none text-gray-400"
      >
